...
public abstract class LibraryItem {
    ...
    // متد کمکی برای نمایش اطلاعات امانت (اختیاری)
    public void displayBorrowInfo(LocalDate expectedReturnDate) {
        if (expectedReturnDate != null) {
            System.out.println("Expected Return: " + expectedReturnDate);
